      ...
      000000                        311 	.ds 8
                                    ...
                                    314 ;--------------------------------------------------------
                                    315 	.area DSEG    (DATA)
      000040                        316 _Disp_1602_str_PARM_2:
      000040                        317 	.ds 1
      000041                        318 _Disp_1602_str_PARM_3:
      000041                        319 	.ds 3
                                    320 ;--------------------------------------------------------
                                    ...
                                    383 ;------------------------------------------------------------
                                    384 ;	./src/DS1302/include/1602.c:18: unsigned char RD_sta() //读状态函数
                                    385 ;	-----------------------------------------
                                    386 ;	 function RD_sta
                                    387 ;	-----------------------------------------
      000208                        388 _RD_sta:
                           ...
                           000001   395 	ar1 = 0x01
                           000000   396 	ar0 = 0x00
                                    397 ;	./src/DS1302/include/1602.c:21: RS_1602 = 0;
                                    398 ;	assignBit
      000208 C2 B6            [12]  399 	clr	_RS_1602
                                    400 ;	./src/DS1302/include/1602.c:22: RW_1602 = 1; //进入读 1602 状态模式
                                    401 ;	assignBit
      00020A D2 B5            [12]  402 	setb	_RW_1602
                                    403 ;	./src/DS1302/include/1602.c:23: EN_1602 = 1; //拉高使能信号
                                    404 ;	assignBit
      00020C D2 B4            [12]  405 	setb	_EN_1602
                                    406 ;	./src/DS1302/include/1602.c:24: sta = P2;    //将 1602 状态数据读取
      00020E 85 A0 82         [24]  407 	mov	dpl,_P2
                                    408 ;	./src/DS1302/include/1602.c:25: EN_1602 = 0; //拉低使能，完成读操作
                                    409 ;	assignBit
      000211 C2 B4            [12]  410 	clr	_EN_1602
                                    411 ;	./src/DS1302/include/1602.c:26: return sta;  //将状态值返
                                    412 ;	./src/DS1302/include/1602.c:27: }
      000213 22               [24]  413 	ret
                                    414 ;------------------------------------------------------------
                                    415 ;Allocation info for local variables in function 'Ready'
                                    416 ;------------------------------------------------------------
                                    417 ;	./src/DS1302/include/1602.c:29: void Ready() //空闲检测函数
                                    418 ;	-----------------------------------------
                                    419 ;	 function Ready
                                    420 ;	-----------------------------------------
      000214                        421 _Ready:
                                    422 ;	./src/DS1302/include/1602.c:31: P2 = 0xFF;
      000214 75 A0 FF         [24]  423 	mov	_P2,#0xff
                                    424 ;	./src/DS1302/include/1602.c:32: while (RD_sta() & 0x80)
      000217                        425 00101$:
      000217 12 02 08         [24]  426 	lcall	_RD_sta
      00021A E5 82            [12]  427 	mov	a,dpl
      00021C 20 E7 F8         [24]  428 	jb	acc.7,00101$
                                    429 ;	./src/DS1302/include/1602.c:34: }
      00021F 22               [24]  430 	ret
                                    431 ;------------------------------------------------------------
                                    432 ;Allocation info for local variables in function 'WR_Cmd'
                                    433 ;------------------------------------------------------------
                                    434 ;cmd                       Allocated to registers r7 
                                    435 ;------------------------------------------------------------
                                    436 ;	./src/DS1302/include/1602.c:36: void WR_Cmd(unsigned char cmd) //写指令函数
                                    437 ;	-----------------------------------------
                                    438 ;	 function WR_Cmd
                                    439 ;	-----------------------------------------
      000220                        440 _WR_Cmd:
      000220 AF 82            [24]  441 	mov	r7,dpl
                                    442 ;	./src/DS1302/include/1602.c:38: Ready(); //检测 1602 是否处于空闲状态
      000222 C0 07            [24]  443 	push	ar7
      000224 12 02 14         [24]  444 	lcall	_Ready
      000227 D0 07            [24]  445 	pop	ar7
                                    446 ;	./src/DS1302/include/1602.c:39: RS_1602 = 0;
                                    447 ;	assignBit
      000229 C2 B6            [12]  448 	clr	_RS_1602
                                    449 ;	./src/DS1302/include/1602.c:40: RW_1602 = 0; //进入写指令模式
                                    450 ;	assignBit
      00022B C2 B5            [12]  451 	clr	_RW_1602
                                    452 ;	./src/DS1302/include/1602.c:41: P2 = cmd;    //将指令数据输出
      00022D 8F A0            [24]  453 	mov	_P2,r7
                                    454 ;	./src/DS1302/include/1602.c:42: EN_1602 = 1; //拉高使能信号
                                    455 ;	assignBit
      00022F D2 B4            [12]  456 	setb	_EN_1602
                                    457 ;	./src/DS1302/include/1602.c:43: EN_1602 = 0; //拉低使能，完成写操作
                                    458 ;	assignBit
      000231 C2 B4            [12]  459 	clr	_EN_1602
                                    460 ;	./src/DS1302/include/1602.c:44: }
      000233 22               [24]  461 	ret
                                    462 ;------------------------------------------------------------
                                    463 ;Allocation info for local variables in function 'WR_Dat'
                                    464 ;------------------------------------------------------------
                                    465 ;dat                       Allocated to registers r7 
                                    466 ;------------------------------------------------------------
                                    467 ;	./src/DS1302/include/1602.c:46: void WR_Dat(unsigned char dat) //写数据函数
                                    468 ;	-----------------------------------------
                                    469 ;	 function WR_Dat
                                    470 ;	-----------------------------------------
      000234                        471 _WR_Dat:
      000234 AF 82            [24]  472 	mov	r7,dpl
                                    473 ;	./src/DS1302/include/1602.c:48: Ready(); //检测 1602 是否处于空闲状态
      000236 C0 07            [24]  474 	push	ar7
      000238 12 02 14         [24]  475 	lcall	_Ready
      00023B D0 07            [24]  476 	pop	ar7
                                    477 ;	./src/DS1302/include/1602.c:49: RS_1602 = 1;
                                    478 ;	assignBit
      00023D D2 B6            [12]  479 	setb	_RS_1602
                                    480 ;	./src/DS1302/include/1602.c:50: RW_1602 = 0; //进入写数据模式
                                    481 ;	assignBit
      00023F C2 B5            [12]  482 	clr	_RW_1602
                                    483 ;	./src/DS1302/include/1602.c:52: P2 = dat; //将数据输出
      000241 8F A0            [24]  484 	mov	_P2,r7
                                    485 ;	./src/DS1302/include/1602.c:54: EN_1602 = 1; //拉高使能信号
                                    486 ;	assignBit
      000243 D2 B4            [12]  487 	setb	_EN_1602
                                    488 ;	./src/DS1302/include/1602.c:55: EN_1602 = 0; //拉低使能，完成写操作
                                    489 ;	assignBit
      000245 C2 B4            [12]  490 	clr	_EN_1602
                                    491 ;	./src/DS1302/include/1602.c:56: }
      000247 22               [24]  492 	ret
                                    493 ;------------------------------------------------------------
                                    494 ;Allocation info for local variables in function 'Init_1602'
                                    495 ;------------------------------------------------------------
                                    496 ;	./src/DS1302/include/1602.c:58: void Init_1602() //1602 初始化函
                                    497 ;	-----------------------------------------
                                    498 ;	 function Init_1602
                                    499 ;	-----------------------------------------
      000248                        500 _Init_1602:
                                    501 ;	./src/DS1302/include/1602.c:60: WR_Cmd(0x38); //设置 16x2 显示，5x7 点阵，8 位数据接口
      000248 75 82 38         [24]  502 	mov	dpl,#0x38
      00024B 12 02 20         [24]  503 	lcall	_WR_Cmd
                                    504 ;	./src/DS1302/include/1602.c:61: WR_Cmd(0x0C); //开显示，关闭光标
      00024E 75 82 0C         [24]  505 	mov	dpl,#0x0c
      000251 12 02 20         [24]  506 	lcall	_WR_Cmd
                                    507 ;	./src/DS1302/include/1602.c:62: WR_Cmd(0x06); //读或写完一个字符后，地址指针、光标均加 1
      000254 75 82 06         [24]  508 	mov	dpl,#0x06
      000257 12 02 20         [24]  509 	lcall	_WR_Cmd
                                    510 ;	./src/DS1302/include/1602.c:63: WR_Cmd(0x01); //数据指针清零、所示显示清零
      00025A 75 82 01         [24]  511 	mov	dpl,#0x01
                                    512 ;	./src/DS1302/include/1602.c:64: }
      00025D 02 02 20         [24]  513 	ljmp	_WR_Cmd
                                    514 ;------------------------------------------------------------
                                    ...
                                    521 ;------------------------------------------------------------
                                    522 ;	./src/DS1302/include/1602.c:66: void Disp_1602_str(unsigned char row, unsigned char column, char *str)
                                    523 ;	-----------------------------------------
                                    524 ;	 function Disp_1602_str
                                    525 ;	-----------------------------------------
      000260                        526 _Disp_1602_str:
      000260 AF 82            [24]  527 	mov	r7,dpl
                                    528 ;	./src/DS1302/include/1602.c:70: addr = (row - 1) * 0x40 + (column - 1); //组合成地址
      000262 1F               [12]  529 	dec	r7
      000263 EF               [12]  530 	mov	a,r7
      000264 03               [12]  531 	rr	a
      000265 03               [12]  532 	rr	a
      000266 54 C0            [12]  533 	anl	a,#0xc0
      000268 FF               [12]  534 	mov	r7,a
      000269 E5 40            [12]  535 	mov	a,_Disp_1602_str_PARM_2
      00026B 14               [12]  536 	dec	a
      00026C 2F               [12]  537 	add	a,r7
                                    538 ;	./src/DS1302/include/1602.c:71: WR_Cmd(0x80 + addr);                    //写地址命令
      00026D 24 80            [12]  539 	add	a,#0x80
      00026F F5 82            [12]  540 	mov	dpl,a
      000271 12 02 20         [24]  541 	lcall	_WR_Cmd
                                    542 ;	./src/DS1302/include/1602.c:73: while (*str) //判断 str 字符串是否已结束
      000274 AD 41            [24]  543 	mov	r5,_Disp_1602_str_PARM_3
      000276 AE 42            [24]  544 	mov	r6,(_Disp_1602_str_PARM_3 + 1)
      000278 AF 43            [24]  545 	mov	r7,(_Disp_1602_str_PARM_3 + 2)
      00027A                        546 00101$:
      00027A 8D 82            [24]  547 	mov	dpl,r5
      00027C 8E 83            [24]  548 	mov	dph,r6
      00027E 8F F0            [24]  549 	mov	b,r7
      000280 12 04 15         [24]  550 	lcall	__gptrget
      000283 FC               [12]  551 	mov	r4,a
      000284 60 18            [24]  552 	jz	00104$
                                    553 ;	./src/DS1302/include/1602.c:75: WR_Dat(*str++); //将 str 字符串数据依次写入
      000286 8C 82            [24]  554 	mov	dpl,r4
      000288 0D               [12]  555 	inc	r5
      000289 BD 00 01         [24]  556 	cjne	r5,#0x00,00116$
      00028C 0E               [12]  557 	inc	r6
      00028D                        558 00116$:
      00028D C0 07            [24]  559 	push	ar7
      00028F C0 06            [24]  560 	push	ar6
      000291 C0 05            [24]  561 	push	ar5
      000293 12 02 34         [24]  562 	lcall	_WR_Dat
      000296 D0 05            [24]  563 	pop	ar5
      000298 D0 06            [24]  564 	pop	ar6
      00029A D0 07            [24]  565 	pop	ar7
      00029C 80 DC            [24]  566 	sjmp	00101$
      00029E                        567 00104$:
                                    568 ;	./src/DS1302/include/1602.c:77: }
      00029E 22               [24]  569 	ret
                                    570 	.area CSEG    (CODE)
                                    571 	.area CONST   (CODE)
                                    572 	.area XINIT   (CODE)
