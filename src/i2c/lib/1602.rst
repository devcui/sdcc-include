      ...
      000085 75 A0 FF         [24]  423 	mov	_P2,#0xff
                                    424 ;	./src/i2c/include/1602.c:32: while (RD_sta() & 0x80)
      000088                        425 00101$:
      000088 12 00 79         [24]  426 	lcall	_RD_sta
      00008B E5 82            [12]  427 	mov	a,dpl
      00008D 20 E7 F8         [24]  428 	jb	acc.7,00101$
                                    429 ;	./src/i2c/include/1602.c:34: }
      000090 22               [24]  430 	ret
                                    431 ;------------------------------------------------------------
      ...
      0000B8 22               [24]  492 	ret
                                    ...
                                    499 ;	-----------------------------------------
      0000B9                        500 _Init_1602:
                                    501 ;	./src/i2c/include/1602.c:60: WR_Cmd(0x38); //设置 16x2 显示，5x7 点阵，8 位数据接口
      0000B9 75 82 38         [24]  502 	mov	dpl,#0x38
      0000BC 12 00 91         [24]  503 	lcall	_WR_Cmd
                                    504 ;	./src/i2c/include/1602.c:61: WR_Cmd(0x0C); //开显示，关闭光标
      0000BF 75 82 0C         [24]  505 	mov	dpl,#0x0c
      0000C2 12 00 91         [24]  506 	lcall	_WR_Cmd
                                    507 ;	./src/i2c/include/1602.c:62: WR_Cmd(0x06); //读或写完一个字符后，地址指针、光标均加 1
      0000C5 75 82 06         [24]  508 	mov	dpl,#0x06
      0000C8 12 00 91         [24]  509 	lcall	_WR_Cmd
                                    510 ;	./src/i2c/include/1602.c:63: WR_Cmd(0x01); //数据指针清零、所示显示清零
      0000CB 75 82 01         [24]  511 	mov	dpl,#0x01
                                    512 ;	./src/i2c/include/1602.c:64: }
      0000CE 02 00 91         [24]  513 	ljmp	_WR_Cmd
                                    514 ;------------------------------------------------------------
                                    ...
                                    525 ;	-----------------------------------------
      0000D1                        526 _Disp_1602_str:
      0000D1 AF 82            [24]  527 	mov	r7,dpl
                                    528 ;	./src/i2c/include/1602.c:70: addr = (row - 1) * 0x40 + (column - 1); //组合成地址
      0000D3 1F               [12]  529 	dec	r7
      0000D4 EF               [12]  530 	mov	a,r7
      0000D5 03               [12]  531 	rr	a
      0000D6 03               [12]  532 	rr	a
      0000D7 54 C0            [12]  533 	anl	a,#0xc0
      0000D9 FF               [12]  534 	mov	r7,a
      0000DA E5 08            [12]  535 	mov	a,_Disp_1602_str_PARM_2
      0000DC 14               [12]  536 	dec	a
      0000DD 2F               [12]  537 	add	a,r7
                                    538 ;	./src/i2c/include/1602.c:71: WR_Cmd(0x80 + addr);                    //写地址命令
      0000DE 24 80            [12]  539 	add	a,#0x80
      0000E0 F5 82            [12]  540 	mov	dpl,a
      0000E2 12 00 91         [24]  541 	lcall	_WR_Cmd
                                    542 ;	./src/i2c/include/1602.c:73: while (*str) //判断 str 字符串是否已结束
      0000E5 AD 09            [24]  543 	mov	r5,_Disp_1602_str_PARM_3
      0000E7 AE 0A            [24]  544 	mov	r6,(_Disp_1602_str_PARM_3 + 1)
      0000E9 AF 0B            [24]  545 	mov	r7,(_Disp_1602_str_PARM_3 + 2)
      0000EB                        546 00101$:
      0000EB 8D 82            [24]  547 	mov	dpl,r5
      0000ED 8E 83            [24]  548 	mov	dph,r6
      0000EF 8F F0            [24]  549 	mov	b,r7
      0000F1 12 02 42         [24]  550 	lcall	__gptrget
      0000F4 FC               [12]  551 	mov	r4,a
      0000F5 60 18            [24]  552 	jz	00104$
                                    553 ;	./src/i2c/include/1602.c:75: WR_Dat(*str++); //将 str 字符串数据依次写入
      0000F7 8C 82            [24]  554 	mov	dpl,r4
      0000F9 0D               [12]  555 	inc	r5
      0000FA BD 00 01         [24]  556 	cjne	r5,#0x00,00116$
      0000FD 0E               [12]  557 	inc	r6
      0000FE                        558 00116$:
      0000FE C0 07            [24]  559 	push	ar7
      000100 C0 06            [24]  560 	push	ar6
      000102 C0 05            [24]  561 	push	ar5
      000104 12 00 A5         [24]  562 	lcall	_WR_Dat
      000107 D0 05            [24]  563 	pop	ar5
      000109 D0 06            [24]  564 	pop	ar6
      00010B D0 07            [24]  565 	pop	ar7
      00010D 80 DC            [24]  566 	sjmp	00101$
      00010F                        567 00104$:
                                    568 ;	./src/i2c/include/1602.c:77: }
      00010F 22               [24]  569 	ret
                                    570 	.area CSEG    (CODE)
                                    571 	.area CONST   (CODE)
                                    572 	.area XINIT   (CODE)
