      ...
      000000                        311 	.ds 8
                                    ...
                                    314 ;--------------------------------------------------------
                                    315 	.area DSEG    (DATA)
      00002D                        316 _Disp_1602_str_PARM_2:
      00002D                        317 	.ds 1
      00002E                        318 _Disp_1602_str_PARM_3:
      00002E                        319 	.ds 3
                                    320 ;--------------------------------------------------------
      ...
      0000DC 75 A0 FF         [24]  423 	mov	_P2,#0xff
                                    424 ;	./src/i2c/include/1602.c:32: while (RD_sta() & 0x80)
      0000DF                        425 00101$:
      0000DF 12 00 D0         [24]  426 	lcall	_RD_sta
      0000E2 E5 82            [12]  427 	mov	a,dpl
      0000E4 20 E7 F8         [24]  428 	jb	acc.7,00101$
                                    429 ;	./src/i2c/include/1602.c:34: }
      0000E7 22               [24]  430 	ret
                                    431 ;------------------------------------------------------------
      ...
      00010F 22               [24]  492 	ret
                                    ...
                                    499 ;	-----------------------------------------
      000110                        500 _Init_1602:
                                    501 ;	./src/i2c/include/1602.c:60: WR_Cmd(0x38); //设置 16x2 显示，5x7 点阵，8 位数据接口
      000110 75 82 38         [24]  502 	mov	dpl,#0x38
      000113 12 00 E8         [24]  503 	lcall	_WR_Cmd
                                    504 ;	./src/i2c/include/1602.c:61: WR_Cmd(0x0C); //开显示，关闭光标
      000116 75 82 0C         [24]  505 	mov	dpl,#0x0c
      000119 12 00 E8         [24]  506 	lcall	_WR_Cmd
                                    507 ;	./src/i2c/include/1602.c:62: WR_Cmd(0x06); //读或写完一个字符后，地址指针、光标均加 1
      00011C 75 82 06         [24]  508 	mov	dpl,#0x06
      00011F 12 00 E8         [24]  509 	lcall	_WR_Cmd
                                    510 ;	./src/i2c/include/1602.c:63: WR_Cmd(0x01); //数据指针清零、所示显示清零
      000122 75 82 01         [24]  511 	mov	dpl,#0x01
                                    512 ;	./src/i2c/include/1602.c:64: }
      000125 02 00 E8         [24]  513 	ljmp	_WR_Cmd
                                    514 ;------------------------------------------------------------
                                    ...
                                    525 ;	-----------------------------------------
      000128                        526 _Disp_1602_str:
      000128 AF 82            [24]  527 	mov	r7,dpl
                                    528 ;	./src/i2c/include/1602.c:70: addr = (row - 1) * 0x40 + (column - 1); //组合成地址
      00012A 1F               [12]  529 	dec	r7
      00012B EF               [12]  530 	mov	a,r7
      00012C 03               [12]  531 	rr	a
      00012D 03               [12]  532 	rr	a
      00012E 54 C0            [12]  533 	anl	a,#0xc0
      000130 FF               [12]  534 	mov	r7,a
      000131 E5 2D            [12]  535 	mov	a,_Disp_1602_str_PARM_2
      000133 14               [12]  536 	dec	a
      000134 2F               [12]  537 	add	a,r7
                                    538 ;	./src/i2c/include/1602.c:71: WR_Cmd(0x80 + addr);                    //写地址命令
      000135 24 80            [12]  539 	add	a,#0x80
      000137 F5 82            [12]  540 	mov	dpl,a
      000139 12 00 E8         [24]  541 	lcall	_WR_Cmd
                                    542 ;	./src/i2c/include/1602.c:73: while (*str) //判断 str 字符串是否已结束
      00013C AD 2E            [24]  543 	mov	r5,_Disp_1602_str_PARM_3
      00013E AE 2F            [24]  544 	mov	r6,(_Disp_1602_str_PARM_3 + 1)
      000140 AF 30            [24]  545 	mov	r7,(_Disp_1602_str_PARM_3 + 2)
      000142                        546 00101$:
      000142 8D 82            [24]  547 	mov	dpl,r5
      000144 8E 83            [24]  548 	mov	dph,r6
      000146 8F F0            [24]  549 	mov	b,r7
      000148 12 04 06         [24]  550 	lcall	__gptrget
      00014B FC               [12]  551 	mov	r4,a
      00014C 60 18            [24]  552 	jz	00104$
                                    553 ;	./src/i2c/include/1602.c:75: WR_Dat(*str++); //将 str 字符串数据依次写入
      00014E 8C 82            [24]  554 	mov	dpl,r4
      000150 0D               [12]  555 	inc	r5
      000151 BD 00 01         [24]  556 	cjne	r5,#0x00,00116$
      000154 0E               [12]  557 	inc	r6
      000155                        558 00116$:
      000155 C0 07            [24]  559 	push	ar7
      000157 C0 06            [24]  560 	push	ar6
      000159 C0 05            [24]  561 	push	ar5
      00015B 12 00 FC         [24]  562 	lcall	_WR_Dat
      00015E D0 05            [24]  563 	pop	ar5
      000160 D0 06            [24]  564 	pop	ar6
      000162 D0 07            [24]  565 	pop	ar7
      000164 80 DC            [24]  566 	sjmp	00101$
      000166                        567 00104$:
                                    568 ;	./src/i2c/include/1602.c:77: }
      000166 22               [24]  569 	ret
                                    570 	.area CSEG    (CODE)
                                    571 	.area CONST   (CODE)
                                    572 	.area XINIT   (CODE)
