      ...
      000359 22               [24]  456 	ret
                                    ...
                                    467 ;	-----------------------------------------
      00035A                        468 _Wr_I2C:
      00035A AF 82            [24]  469 	mov	r7,dpl
                                    470 ;	./src/i2c/include/I2C.c:69: for (mask = 0x80; mask != 0; mask >>= 1)
      00035C 7E 80            [12]  471 	mov	r6,#0x80
      00035E                        472 00105$:
                                    473 ;	./src/i2c/include/I2C.c:76: if ((mask & dat) == 0)
      00035E EF               [12]  474 	mov	a,r7
      00035F 5E               [12]  475 	anl	a,r6
      000360 70 04            [24]  476 	jnz	00102$
                                    477 ;	./src/i2c/include/I2C.c:78: SDA_I2C = 0;
                                    478 ;	assignBit
      000362 C2 82            [12]  479 	clr	_SDA_I2C
      000364 80 02            [24]  480 	sjmp	00103$
      000366                        481 00102$:
                                    482 ;	./src/i2c/include/I2C.c:82: SDA_I2C = 1;
                                    483 ;	assignBit
      000366 D2 82            [12]  484 	setb	_SDA_I2C
      000368                        485 00103$:
                                    486 ;	./src/i2c/include/I2C.c:85: Delay_I2C();
      000368 C0 07            [24]  487 	push	ar7
      00036A C0 06            [24]  488 	push	ar6
      00036C 12 03 2D         [24]  489 	lcall	_Delay_I2C
                                    490 ;	./src/i2c/include/I2C.c:87: SCL_I2C = 1;
                                    491 ;	assignBit
      00036F D2 81            [12]  492 	setb	_SCL_I2C
                                    493 ;	./src/i2c/include/I2C.c:89: Delay_I2C();
      000371 12 03 2D         [24]  494 	lcall	_Delay_I2C
      000374 D0 06            [24]  495 	pop	ar6
      000376 D0 07            [24]  496 	pop	ar7
                                    497 ;	./src/i2c/include/I2C.c:92: SCL_I2C = 0;
                                    498 ;	assignBit
      000378 C2 81            [12]  499 	clr	_SCL_I2C
                                    500 ;	./src/i2c/include/I2C.c:69: for (mask = 0x80; mask != 0; mask >>= 1)
      00037A EE               [12]  501 	mov	a,r6
      00037B C3               [12]  502 	clr	c
      00037C 13               [12]  503 	rrc	a
      00037D FE               [12]  504 	mov	r6,a
      00037E 70 DE            [24]  505 	jnz	00105$
                                    506 ;	./src/i2c/include/I2C.c:95: SDA_I2C = 1;
                                    507 ;	assignBit
      000380 D2 82            [12]  508 	setb	_SDA_I2C
                                    509 ;	./src/i2c/include/I2C.c:96: Delay_I2C();
      000382 12 03 2D         [24]  510 	lcall	_Delay_I2C
                                    511 ;	./src/i2c/include/I2C.c:98: SCL_I2C = 1;
                                    512 ;	assignBit
      000385 D2 81            [12]  513 	setb	_SCL_I2C
                                    514 ;	./src/i2c/include/I2C.c:100: ack = SDA_I2C;
      000387 A2 82            [12]  515 	mov	c,_SDA_I2C
      000389 E4               [12]  516 	clr	a
      00038A 33               [12]  517 	rlc	a
      00038B FF               [12]  518 	mov	r7,a
                                    519 ;	./src/i2c/include/I2C.c:101: Delay_I2C();
      00038C C0 07            [24]  520 	push	ar7
      00038E 12 03 2D         [24]  521 	lcall	_Delay_I2C
      000391 D0 07            [24]  522 	pop	ar7
                                    523 ;	./src/i2c/include/I2C.c:103: SCL_I2C = 0;
                                    524 ;	assignBit
      000393 C2 81            [12]  525 	clr	_SCL_I2C
                                    526 ;	./src/i2c/include/I2C.c:104: return ack;
      000395 8F 82            [24]  527 	mov	dpl,r7
                                    528 ;	./src/i2c/include/I2C.c:105: }
      000397 22               [24]  529 	ret
                                    530 ;------------------------------------------------------------
                                    ...
                                    540 ;	-----------------------------------------
      000398                        541 _RdACK_I2C:
      000398 AF 82            [24]  542 	mov	r7,dpl
                                    543 ;	./src/i2c/include/I2C.c:112: unsigned char dat = 0;
      00039A 7E 00            [12]  544 	mov	r6,#0x00
                                    545 ;	./src/i2c/include/I2C.c:114: SDA_I2C = 1;
                                    546 ;	assignBit
      00039C D2 82            [12]  547 	setb	_SDA_I2C
                                    548 ;	./src/i2c/include/I2C.c:115: for (mask = 0x80; mask != 0; mask >>= 1)
      00039E 7D 80            [12]  549 	mov	r5,#0x80
      0003A0                        550 00105$:
                                    551 ;	./src/i2c/include/I2C.c:118: Delay_I2C();
      0003A0 C0 07            [24]  552 	push	ar7
      0003A2 C0 06            [24]  553 	push	ar6
      0003A4 C0 05            [24]  554 	push	ar5
      0003A6 12 03 2D         [24]  555 	lcall	_Delay_I2C
      0003A9 D0 05            [24]  556 	pop	ar5
      0003AB D0 06            [24]  557 	pop	ar6
      0003AD D0 07            [24]  558 	pop	ar7
                                    559 ;	./src/i2c/include/I2C.c:120: SCL_I2C = 1;
                                    560 ;	assignBit
      0003AF D2 81            [12]  561 	setb	_SCL_I2C
                                    562 ;	./src/i2c/include/I2C.c:121: if (SDA_I2C == 0)
      0003B1 20 82 07         [24]  563 	jb	_SDA_I2C,00102$
                                    564 ;	./src/i2c/include/I2C.c:130: dat &= ~mask;
      0003B4 ED               [12]  565 	mov	a,r5
      0003B5 F4               [12]  566 	cpl	a
      0003B6 FC               [12]  567 	mov	r4,a
      0003B7 52 06            [12]  568 	anl	ar6,a
      0003B9 80 03            [24]  569 	sjmp	00103$
      0003BB                        570 00102$:
                                    571 ;	./src/i2c/include/I2C.c:141: dat |= mask;
      0003BB ED               [12]  572 	mov	a,r5
      0003BC 42 06            [12]  573 	orl	ar6,a
      0003BE                        574 00103$:
                                    575 ;	./src/i2c/include/I2C.c:144: Delay_I2C();
      0003BE C0 07            [24]  576 	push	ar7
      0003C0 C0 06            [24]  577 	push	ar6
      0003C2 C0 05            [24]  578 	push	ar5
      0003C4 12 03 2D         [24]  579 	lcall	_Delay_I2C
      0003C7 D0 05            [24]  580 	pop	ar5
      0003C9 D0 06            [24]  581 	pop	ar6
      0003CB D0 07            [24]  582 	pop	ar7
                                    583 ;	./src/i2c/include/I2C.c:146: SCL_I2C = 0;
                                    584 ;	assignBit
      0003CD C2 81            [12]  585 	clr	_SCL_I2C
                                    586 ;	./src/i2c/include/I2C.c:115: for (mask = 0x80; mask != 0; mask >>= 1)
      0003CF ED               [12]  587 	mov	a,r5
      0003D0 C3               [12]  588 	clr	c
      0003D1 13               [12]  589 	rrc	a
      0003D2 FD               [12]  590 	mov	r5,a
      0003D3 70 CB            [24]  591 	jnz	00105$
                                    592 ;	./src/i2c/include/I2C.c:149: SDA_I2C = ack;
                                    593 ;	assignBit
      0003D5 EF               [12]  594 	mov	a,r7
      0003D6 24 FF            [12]  595 	add	a,#0xff
      0003D8 92 82            [24]  596 	mov	_SDA_I2C,c
                                    597 ;	./src/i2c/include/I2C.c:151: Delay_I2C();
      0003DA C0 06            [24]  598 	push	ar6
      0003DC 12 03 2D         [24]  599 	lcall	_Delay_I2C
                                    600 ;	./src/i2c/include/I2C.c:153: SCL_I2C = 1;
                                    601 ;	assignBit
      0003DF D2 81            [12]  602 	setb	_SCL_I2C
                                    603 ;	./src/i2c/include/I2C.c:155: Delay_I2C();
      0003E1 12 03 2D         [24]  604 	lcall	_Delay_I2C
      0003E4 D0 06            [24]  605 	pop	ar6
                                    606 ;	./src/i2c/include/I2C.c:157: SCL_I2C = 0;
                                    607 ;	assignBit
      0003E6 C2 81            [12]  608 	clr	_SCL_I2C
                                    609 ;	./src/i2c/include/I2C.c:158: return dat;
      0003E8 8E 82            [24]  610 	mov	dpl,r6
                                    611 ;	./src/i2c/include/I2C.c:159: }
      0003EA 22               [24]  612 	ret
                                    613 	.area CSEG    (CODE)
                                    614 	.area CONST   (CODE)
                                    615 	.area XINIT   (CODE)
