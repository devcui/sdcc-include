      ...
      000248 75 A0 FF         [24]  423 	mov	_P2,#0xff
                                    424 ;	./src/ir/include/1602.c:32: while (RD_sta() & 0x80)
      00024B                        425 00101$:
      00024B 12 02 3C         [24]  426 	lcall	_RD_sta
      00024E E5 82            [12]  427 	mov	a,dpl
      000250 20 E7 F8         [24]  428 	jb	acc.7,00101$
                                    429 ;	./src/ir/include/1602.c:34: }
      000253 22               [24]  430 	ret
                                    431 ;------------------------------------------------------------
      ...
      000267 22               [24]  461 	ret
                                    ...
                                    470 ;	-----------------------------------------
      000268                        471 _WR_Dat:
      000268 AF 82            [24]  472 	mov	r7,dpl
                                    473 ;	./src/ir/include/1602.c:48: Ready(); //检测 1602 是否处于空闲状态
      00026A C0 07            [24]  474 	push	ar7
      00026C 12 02 48         [24]  475 	lcall	_Ready
      00026F D0 07            [24]  476 	pop	ar7
                                    477 ;	./src/ir/include/1602.c:49: RS_1602 = 1;
                                    478 ;	assignBit
      000271 D2 B6            [12]  479 	setb	_RS_1602
                                    480 ;	./src/ir/include/1602.c:50: RW_1602 = 0; //进入写数据模式
                                    481 ;	assignBit
      000273 C2 B5            [12]  482 	clr	_RW_1602
                                    483 ;	./src/ir/include/1602.c:52: P2 = dat; //将数据输出
      000275 8F A0            [24]  484 	mov	_P2,r7
                                    485 ;	./src/ir/include/1602.c:54: EN_1602 = 1; //拉高使能信号
                                    486 ;	assignBit
      000277 D2 B4            [12]  487 	setb	_EN_1602
                                    488 ;	./src/ir/include/1602.c:55: EN_1602 = 0; //拉低使能，完成写操作
                                    489 ;	assignBit
      000279 C2 B4            [12]  490 	clr	_EN_1602
                                    491 ;	./src/ir/include/1602.c:56: }
      00027B 22               [24]  492 	ret
                                    493 ;------------------------------------------------------------
                                    ...
                                    499 ;	-----------------------------------------
      00027C                        500 _Init_1602:
                                    501 ;	./src/ir/include/1602.c:60: WR_Cmd(0x38); //设置 16x2 显示，5x7 点阵，8 位数据接口
      00027C 75 82 38         [24]  502 	mov	dpl,#0x38
      00027F 12 02 54         [24]  503 	lcall	_WR_Cmd
                                    504 ;	./src/ir/include/1602.c:61: WR_Cmd(0x0C); //开显示，关闭光标
      000282 75 82 0C         [24]  505 	mov	dpl,#0x0c
      000285 12 02 54         [24]  506 	lcall	_WR_Cmd
                                    507 ;	./src/ir/include/1602.c:62: WR_Cmd(0x06); //读或写完一个字符后，地址指针、光标均加 1
      000288 75 82 06         [24]  508 	mov	dpl,#0x06
      00028B 12 02 54         [24]  509 	lcall	_WR_Cmd
                                    510 ;	./src/ir/include/1602.c:63: WR_Cmd(0x01); //数据指针清零、所示显示清零
      00028E 75 82 01         [24]  511 	mov	dpl,#0x01
                                    512 ;	./src/ir/include/1602.c:64: }
      000291 02 02 54         [24]  513 	ljmp	_WR_Cmd
                                    514 ;------------------------------------------------------------
                                    ...
                                    525 ;	-----------------------------------------
      000294                        526 _Disp_1602_str:
      000294 AF 82            [24]  527 	mov	r7,dpl
                                    528 ;	./src/ir/include/1602.c:70: addr = (row - 1) * 0x40 + (column - 1); //组合成地址
      000296 1F               [12]  529 	dec	r7
      000297 EF               [12]  530 	mov	a,r7
      000298 03               [12]  531 	rr	a
      000299 03               [12]  532 	rr	a
      00029A 54 C0            [12]  533 	anl	a,#0xc0
      00029C FF               [12]  534 	mov	r7,a
      00029D E5 0B            [12]  535 	mov	a,_Disp_1602_str_PARM_2
      00029F 14               [12]  536 	dec	a
      0002A0 2F               [12]  537 	add	a,r7
                                    538 ;	./src/ir/include/1602.c:71: WR_Cmd(0x80 + addr);                    //写地址命令
      0002A1 24 80            [12]  539 	add	a,#0x80
      0002A3 F5 82            [12]  540 	mov	dpl,a
      0002A5 12 02 54         [24]  541 	lcall	_WR_Cmd
                                    542 ;	./src/ir/include/1602.c:73: while (*str) //判断 str 字符串是否已结束
      0002A8 AD 0C            [24]  543 	mov	r5,_Disp_1602_str_PARM_3
      0002AA AE 0D            [24]  544 	mov	r6,(_Disp_1602_str_PARM_3 + 1)
      0002AC AF 0E            [24]  545 	mov	r7,(_Disp_1602_str_PARM_3 + 2)
      0002AE                        546 00101$:
      0002AE 8D 82            [24]  547 	mov	dpl,r5
      0002B0 8E 83            [24]  548 	mov	dph,r6
      0002B2 8F F0            [24]  549 	mov	b,r7
      0002B4 12 04 17         [24]  550 	lcall	__gptrget
      0002B7 FC               [12]  551 	mov	r4,a
      0002B8 60 18            [24]  552 	jz	00104$
                                    553 ;	./src/ir/include/1602.c:75: WR_Dat(*str++); //将 str 字符串数据依次写入
      0002BA 8C 82            [24]  554 	mov	dpl,r4
      0002BC 0D               [12]  555 	inc	r5
      0002BD BD 00 01         [24]  556 	cjne	r5,#0x00,00116$
      0002C0 0E               [12]  557 	inc	r6
      0002C1                        558 00116$:
      0002C1 C0 07            [24]  559 	push	ar7
      0002C3 C0 06            [24]  560 	push	ar6
      0002C5 C0 05            [24]  561 	push	ar5
      0002C7 12 02 68         [24]  562 	lcall	_WR_Dat
      0002CA D0 05            [24]  563 	pop	ar5
      0002CC D0 06            [24]  564 	pop	ar6
      0002CE D0 07            [24]  565 	pop	ar7
      0002D0 80 DC            [24]  566 	sjmp	00101$
      0002D2                        567 00104$:
                                    568 ;	./src/ir/include/1602.c:77: }
      0002D2 22               [24]  569 	ret
                                    570 	.area CSEG    (CODE)
                                    571 	.area CONST   (CODE)
                                    572 	.area XINIT   (CODE)
